...
try {
  ...
  const allowedFields = ["assets", "auditEntries", "checksum", "databaseVersion", "expenses", "exportedAt", "goals", "incomes", "insurancePolicies", "liabilities", "positions", "recommendationDecisions", "retentionPolicy", "scenarios", "schema", "settings"].sort();
  ...
  assert(runtimeChecks.disasterRecoveryDrill.dryRun.storePlan.length === 11, "disaster recovery drill did not cover all backup stores");

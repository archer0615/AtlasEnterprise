...
for (const id of [
  ...
  "validationHistoryPanel", "cacheVersionText", "cacheVersionFooter", "reportVersionPanel", "generateValidationSummaryButton", "offlineRepairButton",
  "offlineRepairPanel", "reportVersionHistoryPanel", "exportValidationButton", "validationExportPanel", "performanceBudgetTrendPanel", "releaseEvidenceArchivePanel",
...
for (const token of [
  ...
  "translateStoreName",
  "renderRecommendationControls", "renderRecommendationHistory", "renderScenarioComparison", "sortScenarioComparisonSource",
  "renderLoanScenarioPanel", "setRecommendationDecision", "exportPortfolioReport",
  "wrapExportReport", "repairOfflineData", "buildReportVersionHistory", "exportValidationResult", "generateValidationSummary", "renderPerformanceBudgetTrend", "renderReleaseEvidenceArchive",

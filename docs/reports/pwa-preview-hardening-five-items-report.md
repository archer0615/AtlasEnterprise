...
| Visual Pixel Diff Validation | Completed | Visual regression now compares newly captured screenshots against existing PNG baselines with a pixel drift threshold. |
...
| `frontend/scripts/validate-visual-regression.mjs` | Adds PNG baseline pixel diff validation. |

...
| Insurance policy runtime | Implemented | `frontend/src/domain/insurance/`, `frontend/src/application/insurance/`, `frontend/src/features/insurance/insurance-controller.js`, `frontend/scripts/test-insurance-integration.mjs`, `frontend/scripts/test-insurance-backup-restore-browser.mjs`, `frontend/scripts/test-insurance-owner-isolation-browser.mjs`, `frontend/scripts/test-insurance-restore-conflict-browser.mjs` | Local IndexedDB policy create/update/cancel/listing plus coverage summary, audit history, CSV dry-run/commit mapping, backup restore, restore conflict policy, duplicate feedback, owner isolation, and browser integration coverage. |
